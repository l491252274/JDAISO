...
<c:set var="buttons">
   <table><tr>
           <td>
              <s:form action="user_user_listBySearchUsername_ADMIN" method="post">
...
<display:table name="users" cellspacing="0" cellpadding="0" requestURI="/user_user_list_ADMIN.html"
    ...
    <display:column titleKey="list.operate" sortable="false" headerClass="sortable" style="width:100px; word-break:break-all;">
    		...
    		<input type="button" onclick="location.href='/${appConfig['project.name']}/user_user_edit_PUBLIC.html?userId=${theUser.id}&from=list&menu='" value="<fmt:message key="button.edit"/>"/>
    		</td>
    	</tr></table>
	</display:column>

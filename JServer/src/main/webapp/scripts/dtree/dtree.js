...
function dTree(objName) {
	...
	this.icon = {
		...
		lock			: 'images/dtree/lock.gif',
		iclass			: 'images/dtree/class.gif',
		iclassOpen	: 'images/dtree/classopen.gif',
		ispeciality			: 'images/dtree/speciality.gif',
		ispecialityOpen	: 'images/dtree/specialityopen.gif',
		ischool			: 'images/dtree/school.gif',
		ischoolOpen	: 'images/dtree/schoolopen.gif',
		iuniversity			: 'images/dtree/university.gif',
		iuniversityOpen	: 'images/dtree/universityopen.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];

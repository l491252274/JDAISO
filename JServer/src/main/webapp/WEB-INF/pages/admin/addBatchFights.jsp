...
<body onload="init();">
	<h1><p align="center">Add Batch Fights</p></h1>
	<p align="center">
	<table width="100%" border="0" align="center">
		<tr><td>
		<div id="divsource" style="display:block;">
			<s:form id="form1" name="form1" action="addBatchFights" method="post">
				<h1><p align="center">Format:&nbsp;gameId,&nbsp;userNameA,&nbsp;userNameB</p></h1>
				<s:textarea tooltip="Enter Data" label="Source" name="addBatchFightData" rows="12" />
				<p align=center><font color=red>per fight per line</font></p>

...
<body onload="init();">
	<h1><p align="center">Batch Add Users</p></h1>
	<p align="center">
	<table width="100%" border="0" align="center">
		<tr><td>
		<div id="divsource" style="display:block;">
			<s:form id="form1" name="form1" action="user_user_batchAddUsersForm_SubmitSave_ADMIN" method="post">
				<h1><p align="center">Format:&nbsp;user name,&nbsp;password,&nbsp;truename,&nbsp;student number,&nbsp;class name,&nbsp;school name,&nbsp;alias,&nbsp;location</p></h1>
				<s:textarea tooltip="Enter Data" label="Source" name="addBatchUserData" rows="12" />

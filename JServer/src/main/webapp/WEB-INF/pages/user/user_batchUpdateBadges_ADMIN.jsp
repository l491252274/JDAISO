...
<body onload="init();">
	<h1><p align="center">Add Batch Update Badges</p></h1>
	<p align="center">
	<table width="100%" border="0" align="center">
		<tr><td>
		<div id="divsource" style="display:block;">
			<s:form id="form1" name="form1" action="user_user_batchSaveBadges_ADMIN" method="post">
				<h1><p align="center">Format:&nbsp;user name,&nbsp;[-]badge code</p></h1>
				<s:textarea tooltip="Enter Data" label="Source" name="updateBatchBadgeData" rows="12" />

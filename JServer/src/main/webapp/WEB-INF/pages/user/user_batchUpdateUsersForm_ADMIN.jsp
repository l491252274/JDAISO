...
<body onload="init();">
	<h1><p align="center">Batch Update Users</p></h1>
	<p align="center">
	<table width="100%" border="0" align="center">
		<tr><td>
		<div id="divsource" style="display:block;">
			<s:form id="form1" name="form1" action="user_user_batchUpdateUsersForm_SubmitSave_ADMIN" method="post">
				<h1><p align="center">Format:&nbsp;user name,&nbsp;password,&nbsp;alias,&nbsp;truename,&nbsp;location,&nbsp;enable</p></h1>

...
<c:set var="buttons">
   <table><tr>
           ...
           <td>           
              <s:form action="user_user_listBySearchRole_ADMIN" method="post">
                   <s:hidden key="searchKey" value="role"/>
               <div>
                   <table>
                       <tr>
                        <td>
...
<display:table name="users" cellspacing="0" cellpadding="0" requestURI="/user_user_listBySearchRole_ADMIN.html"

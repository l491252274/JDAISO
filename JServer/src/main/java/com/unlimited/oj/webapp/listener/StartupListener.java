...
public class StartupListener implements ServletContextListener
{
	...
	public void contextInitialized(ServletContextEvent event)
	{
		...
		if (context.getInitParameter(Constants.PROJECT_NAME) != null)
		{
			config.put(Constants.PROJECT_NAME, context
					.getInitParameter(Constants.PROJECT_NAME));
		}
		...
		// add application properties, Checkie
		ApplicationConfig.init(context.getRealPath("/")); // init ServerConfig
